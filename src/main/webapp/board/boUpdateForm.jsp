	...
	<div class="container">
		...
		<form action="<%=withFormTag%>" method="post">
			...
			<div class="input-group">
				...
				<c:set var="userInfo" value="${bean.id}(${bean.id})"/>
				<input id="fakeid" name="fakeid" disabled="disabled"
				 	type="text" class="form-control" placeholder="" value="${userInfo}">
				 
				<input id="id" name="id" type="text" value="${bean.id}">
			</div>
			<div class="input-group">
				<span class="input-group-text col-md-2">제목</span>
				<input class="form-control" type="text" id="subject" name="subject" value="${requestScope.bean.subject}">
			</div>
			<div class="input-group">
				<span class="input-group-text col-md-2">내용</span>
				<input class="form-control" type="text" id="content" name="content" value="${requestScope.bean.content}">
			</div>
			
			<div class="input-group">
				<span class="input-group-text col-md-2">비밀번호</span>
				<input id="password" name="password" type="password"  class="form-control" value="${requestScope.bean.password}">
			</div>
			<div class="input-group" >
				<span class="input-group-text col-md-2">등록일자</span>
				<input class="form-control date_style" type="datetime" id="regdate" name="regdate" value="${requestScope.bean.regdate}">
			</div>
			
		
			<div id="buttonset" class="input-group">
				<button type="submit" class="btn btn-primary" 
					onclick="return validCheck();">수정하기
				</button>
				<!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
